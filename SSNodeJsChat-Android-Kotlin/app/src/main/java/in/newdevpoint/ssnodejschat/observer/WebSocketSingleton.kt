...
class WebSocketSingleton : WebSocketListener(), WebSocketSubject {
    ...
    private fun joinCommand() {
        ...
        PreferenceUtils.getRegisterUser(AppApplication.applicationContext)?.let { userDetails ->
            ...
            try {
                ...
                jsonObject.put(
                    KeyConstant.REQUEST_TYPE_KEY,
                    KeyConstant.REQUEST_TYPE_CREATE_CONNECTION
                )
