...
class PreferenceUtils {
    ...
    companion object {
        ...
        fun saveTopScorerData(context: Context, data: String?) {
            val editor =
                context.getSharedPreferences(PREF_SAVE_TOP_SCORER_DATA, Context.MODE_PRIVATE).edit()
        ...
        fun saveNotificationData(context: Context, data: String?) {
            val editor =
                context.getSharedPreferences(PREF_SAVE_NOIFICATION_COUNT_DATA, Context.MODE_PRIVATE)
                    .edit()
       ...
       /* fun isUserLogin(context: Context?): Boolean {
            return getRegisterUser(context) != null
