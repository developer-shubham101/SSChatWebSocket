...
class NetworkManager {
    ...
    static let SITE_URL = isLocal ? LOCAL_SITE_URL : LIVE_SITE_URL;
    
    
    static let STORAGE_URL = SITE_URL;
    ...
    static let URL_WEB_SOCKET = isLocal ? LOCAL_SOCKET_URL : LIVE_SOCKET_URL
